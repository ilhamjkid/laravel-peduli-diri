<div class="row justify-content-center">
    <div class="col-12 col-lg-10 col-xl-9">
        <div class="card shadow overflow-hidden mb-3" style="border-radius: 10px">
            <div class="card-body">
                <form wire:submit.prevent='update' class="row justify-content-center">
                    ...
                    <div class="col-12 my-3 mt-md-0 px-4">
                        <button wire:click='backToAll' type="button" class="btn btn-primary me-1" style="border-radius: 6px">
                            Kembali
                        </button>
